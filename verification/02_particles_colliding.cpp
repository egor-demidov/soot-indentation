...
using binary_force_container_t = binary_force_functor_container<Eigen::Vector3d, double, contact_force_functor_t>; // Binary force container
...
int main() {
    ...
    std::ofstream ofs("../plots/verification/02_particles_colliding.dat");
