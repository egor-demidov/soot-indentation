...
using contact_functor_t = alt_sinter_functor<Eigen::Vector3d, double>;
...
using binary_functors_t = binary_force_functor_container<Eigen::Vector3d, double, vdw_functor_t, contact_functor_t>;
...
int main() {
    ...
    contact_functor_t sinter_model(x0.size(), x0,
